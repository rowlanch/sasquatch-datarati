...
filename medicare ZIP 'C:\sasquatch-data\Medicare_Physician_and_Other_Supplier_NPI_Aggregate_CY2015.zip';

DATA project.MedicareAgg2015;
	LENGTH
		npi              					$ 10
	...
	INFILE medicare(Medicare_Physician_and_Other_Supplier_NPI_Aggregate_CY2015.txt)

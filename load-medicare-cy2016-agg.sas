...
filename medicare ZIP 'C:\sasquatch-data\Medicare-Physician-and-Other-Supplier-NPI-Aggregate_CY2016.zip';

DATA project.MedicareAgg2016;
	LENGTH
		npi              					$ 10
	...
	INFILE medicare(Medicare_Physician_and_Other_Supplier_NPI_Aggregate_CY2016.txt)
